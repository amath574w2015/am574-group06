% Function to generate plots in the U plane for the AR model.
% Input: validity - boolean indicating whether or not validity is being
%                    considered
